                                ...
                                <div class="video-card">
                                    ...
                                    <div class="video-card-body">
                                        ...
                                        <div class="video-page text-success">
                                            <?= $video['name'] ?> <a title="" data-placement="top" data-toggle="tooltip" href="http://localhost/Vidoe/View/video-page.php?id=<?= $video['video_id'] ?>" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></a>
                                        </div>
