                                ...
                                <form method="post" enctype="multipart/form-data" action="channelForm.php">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Video's title" id="e1" class="form-control" name="name">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input id="e2" name="logo" class="form-control" placeholder="Enter Video's description" type="file">
